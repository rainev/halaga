  ...
  return (
    <>
      ...
      <section className={cn(panel, 'overflow-hidden')}>
        ...
        <div className="relative border-y border-[var(--app-border)] bg-[var(--app-feature)] px-5 py-7 text-[var(--app-text)] sm:px-10"><span className="absolute left-5 top-0 h-[3px] w-10 bg-[var(--app-text)] sm:left-10" /><p className="text-[10px] text-[var(--app-muted)]">For your level {activeRisk} · {RISK_PROFILES[activeRisk].label}</p><h2 className="mt-2 font-serif text-3xl font-normal sm:text-4xl">{brief.headline}</h2></div>
